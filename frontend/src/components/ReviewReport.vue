                ...
                <div class="flex align-middle gap-3">
                    ...
                    >
                        ...
                        <div class="flex justify-end gap-2">
                            <button @click="handleDelete" class="bg-red-600 text-white rounded-full px-4 py-1 text-sm cursor-pointer">Yes, Delete</button>
                            <button @click="showModal = false" class="bg-primary text-white rounded-full px-4 py-1 text-sm cursor-pointer">Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
